...
export const BookCard: React.FC<BookCardProps> = ({ 
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="group relative bg-white rounded-2xl border border-slate-200 p-3 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col justify-between cursor-pointer select-none"
    >
      ...
      <div className="relative w-full aspect-[3/4] rounded-xl overflow-hidden bg-slate-100 mb-3 border border-slate-100">
        ...
        {/* Top Badges (Format & Stock Indicator) */}
      ...
      {/* 2. Card Content (Category, Title, Author) */}
      <div className="space-y-1.5 flex-1 flex flex-col justify-between">
        ...
        <div className="pt-2.5 mt-2 border-t border-slate-100 flex items-center justify-between">
          ...
          {!isPreview && isBorrowable && onBorrow ? (
            <button
              type="button"
